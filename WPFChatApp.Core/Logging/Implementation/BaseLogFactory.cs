...
{
    /// <summary>
    /// The standard log factory for the WPFChatApp
    ...
    public class BaseLogFactory : ILogFactory
    {
        ...
        /// <summary>
        /// The list of loggers in the factory
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        /// <param name="loggers">The loggers to add to the factory, on the top of the stock loggers already included</param>
