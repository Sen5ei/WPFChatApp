...
namespace WPFChatApp.Web.Server
{
    ...
    public class ApiController : Controller
    {
        ...
        /// <summary>
        /// The manager for handling users creation, deletion, searching, roles...
        /// </summary>
        ...
        private async Task SendUserEmailVerificationAsync(ApplicationUser user)
        {
            ...
            await WPFChatAppEmailSender.SendUserVerificationEmailAsync(user.UserName, userIdentity.Email, confirmationUrl);
        } 
